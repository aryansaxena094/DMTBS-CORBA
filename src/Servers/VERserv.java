...
public class VERserv {
    public static String servername = "Verdun";
    ...
    public static void main(String[] args) {
        try {
            ...
            VERImpl serv3 = new VERImpl();
            serv3.setOrb(orb);
            
            org.omg.CORBA.Object ref = rootpoa.servant_to_reference(serv3);
            ...
            NameComponent path[] = ((NamingContextExtOperations) ncRef).to_name("VER");
