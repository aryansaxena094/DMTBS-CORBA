...
public class _ServerStub extends org.omg.CORBA.portable.ObjectImpl implements ServerSide.Server
{
  ...
  public String exchangeTickets (String customerID, String movieID, String movieName, String new_movieID, String new_movieName, int numberOfTickets)
  {
            ...
            try {
                ...
                return exchangeTickets (customerID, movieID, movieName, new_movieID, new_movieName, numberOfTickets        );
            } finally {
                _releaseReply ($in);
            }
  } // exchangeTickets
  ...
  public void bookingservertoserver (String data)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("bookingservertoserver", true);
                ...
                bookingservertoserver (data        );
            } finally {
                _releaseReply ($in);
            }
  } // bookingservertoserver
